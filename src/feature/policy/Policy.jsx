  ...
  return (
    <div id="policy">
      ...
      <p>
        ...
        and advertisers. This is not linked to any personal information that can
        ...
        track and target the interests of our users to enhance their experience
        on our site. Usage of a cookie is in no way linked to any personally
        identifiable information on our site.
        <br />
        <br />
        Some of our business partners may use cookies on our site (e.g.,
        ...
        <br />
        <br />
        Whenever material changes are made to the privacy notice specify how you
        ...
        <br />
        <br />
        Numerous other provisions and/or practices may be required as a result
        of laws, international treaties, or industry practices. It is up to you
        to determine what additional practices must be followed and/or what
        additional disclosures are required. Please take special notice of the
        General Data Protection Regulation (GDPR) which is frequently amended.
        <br />
        <br />
        If you feel that we are not abiding by this privacy policy, you should
        contact us immediately via telephone at +995 551211844 or via email at
        info@did.ge
      </p>
    </div>
  );
