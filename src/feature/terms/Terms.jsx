    ...
    <div id="terms">
      ...
      <ul>
        <li>
          ...
          herein on this webulage, shall govern your use of this website,
        ...
        <li>
          ...
          storiai.com LLC and/or its licensors own all rights to the
        ...
        <li>
          3. Restrictions. You are expressly and emphatically restricted from
          all of the following: publishing any Website material in any media;
          ...
          this Website are restricted from access by you and storiai.com LLC may
        ...
        <li>
          ...
          by displaying it, you grant storiai.com LLC a non-exclusive,
          ...
          media. Your Content must be your own and must not be infringing on any
          third party’s rights. storiai.com LLC reserves the right to remove any
        ...
        <li>
          ...
          and storiai.com LLC makes no express or implied representations or
          ...
          <li>
            6. Limitation of liability. In no event shall storiai.com LLC, nor
            any of its officers, directors and employees, be liable to you for
            ...
            otherwise, and storiai.com LLC, including its officers, directors
            and employees shall not be liable for any indirect, consequential or
            special liability arising out of or in any way related to your use
            of this Website.
          </li>
        </li>
        <li>
          7. Indemnification. You hereby indemnify to the fullest extent
          storiai.com LLC from and against any and all liabilities, costs,
          demands, causes of action, damages and expenses (including reasonable
        ...
        <li>
          9. Variation of Terms. storiai.com LLC is permitted to revise these
        ...
        <li>
          10. Assignment. storiai.com LLC shall be permitted to assign,
          ...
          shall not be permitted to assign, transfer, or subcontract any of your
          rights and/or obligations under these Terms. 11. Entire Agreement.
          These Terms, including any legal notices and disclaimers contained on
          this Website, constitute the entire agreement between storiai.com LLC
          and you in relation to your use of this Website, and supersede all
          prior agreements and understandings with respect to the same. 12.
          Governing Law & Jurisdiction. These Terms will be governed by and
          construed in accordance with the laws of Georgia, and you submit to
          the non-exclusive jurisdiction of the state courts located in Georgia
